...
config_dir="${XDG_CONFIG_HOME:-$HOME/.config}/preview_ohmyzsh_themes"
last_theme_file="$config_dir/last_theme"

# Create a temporary directory for ZDOTDIR
temp_zdotdir=$(mktemp -d /tmp/zsh_theme_preview.XXXXXX)
zsh_rc_file="$temp_zdotdir/.zshrc"
...
while true; do
    ...
    create_zshrc "$theme" "${preview_plugins[@]}"
